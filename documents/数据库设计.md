...
| ------------ | ------------- | ---------------- | ---- |
| id           | bigserial     | 主键             | 自增 |
| session_id   | bigserial | 会话ID           | 外键 → `ai_chat_session.id` |
| message_id   | bigserial | 消息ID           | 外键 → `ai_chat_message.id`；可为空 |
...
| ------------ | ------------- | ---------------- | ---- |
| id           | bigserial     | 主键             | 自增 |
| owner_user_id| bigserial  | 所属用户         | 外键 → `user.id`；不可为空 |
...
| -------------- | ------------ | ---------------- | ---- |
| id              | bigserial    | 主键             | 自增 |
| session_id   | bigserial    | 会话ID           | 外键 → `ai_chat_session.id`；唯一（若一会话只绑定一个PDF） |
